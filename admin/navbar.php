                ...
                <div class="row-fluid">
                    ...
                    <div class="span6">
                        ...
                        <div class="pull-right">
                            ...
                            <?php 
                                $table = '"Admin"';
                                $user_query=pg_query("select * from $table where admin_id='$session_id'")or die(pg_errormessage());
                                $row=  pg_fetch_array($user_query);
                            ?>
                            <a href="" class="btn btn-info">Welcome:<i class="icon-user icon-large"></i>&nbsp;<?php echo $row['name']." "; ?></a>
                        </div>
                    </div>
                </div>
            </div>
