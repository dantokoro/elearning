						...
						<div class="col-12 col-lg-6 d-flex flex-wrap justify-content-center justify-content-lg-end align-items-center">
							<div class="header-bar-search">
								<form class="flex align-items-stretch">
									...
									<button type="submit" value="" class="flex justify-content-center align-items-center"><i class="fa fa-search"></i>
									</button>
								</form>
							</div>
							<!-- .header-bar-search -->
							<div class="header-bar-menu">
								<ul class="flex justify-content-center align-items-center py-2 pt-md-0">
									<?php if(empty($username)) { echo '<li><a href="login.php">Register/Login</a></li>'; } else { echo '<li><a href="profile.php">Hi '.$username. '</a></li>'; } ?>
								</ul>
							</div>
							<!-- .header-bar-menu -->
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6" style="position: relative; left: 25%; transform: translate(-50%, -10%); top: 20px;">
					<?php all_course_printer($conn, $user_id); ?>
				</div>
			</div>
			<!-- row -->
		</div>
