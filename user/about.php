        ...
        <div class="row">
            <div class="col-12">
                <div class="about-heading">
                    <h2 class="entry-title">Welcome to DABAKI ACADEMY</h2>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="team-member">
                    ...
                    <ul class="p-0 m-0 d-flex justify-content-center align-items-center">
                        <li><a href="https://www.facebook.com/profile.php?id=100006544300128"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="team-member">
                    ...
                    <ul class="p-0 m-0 d-flex justify-content-center align-items-center">
                        <li><a href="https://www.facebook.com/kien.nguyen.182940"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                    </ul>
                </div><!-- .team-member -->
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="team-member">
                    ...
                    <ul class="p-0 m-0 d-flex justify-content-center align-items-center">
                        <li><a href="https://www.facebook.com/profile.php?id=100006508421578"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                    </ul>
                </div><!-- .team-member -->
