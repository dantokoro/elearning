...
function one_course($id){													//HÀM IN RA 1 KHÓA HỌC (dùng trong file index_login) 
		...
		echo	'<div class="col-12 col-md-6 col-lg-4 px-25">
                                ...
                                <div class="course-content-wrap">
                                    <header class="entry-header">
                                        ...
                                        <div class="entry-meta flex align-items-center">
                                            <div class="course-author"><a href="teacher/teacher.php?id='.$teacher["teacher_id"].'">'.$teacher["name"].'</a></div>

                                            <div class="course-date">'.date('j F,Y', strtotime($info["created_at"])).'</div>
                                        </div><!-- .course-date -->
                                    </header><!-- .entry-header -->
             ...
             echo                          ' <span class="course-ratings-count">('.$rating["count"].' rates)</span>
                                        </div><!-- .course-ratings -->
                                    </footer><!-- .entry-footer -->
...
function suggest_course($id){													//HÀM IN RA 1 KHÓA HỌC TRONG PHẦN SUGGEST
					require('login/db.php');
	...
	function print_teacher_course($id){													//HÀM IN RA 1 KHÓA HỌC (dùng trong file teacher.php) 
					require('login/db.php');
                            ...
                            <div class="course-content">
                                ...
                                <div class="course-content-wrap">
                                    <header class="entry-header">
                                        <h2 class="entry-title"><a href="../single-courses.php?id='. $id .'">'.$info["name"].'</a></h2>
                                        <div class="entry-meta flex flex-wrap align-items-center">
                                            <div class="course-author"><a href="teacher.php?id='.$teacher["teacher_id"].'">'.$teacher["name"].'</a></div>
